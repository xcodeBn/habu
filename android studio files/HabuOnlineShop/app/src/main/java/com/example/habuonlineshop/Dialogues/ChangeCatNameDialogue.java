...
public class ChangeCatNameDialogue extends AppCompatDialogFragment {


    private EditText name;
    private ChangeCatListener listener;
    ...
    public void onAttach(@NonNull Context context) {
        ...
        try {
            listener = (ChangeCatListener) context;
        }
    ...
    public interface ChangeCatListener {
